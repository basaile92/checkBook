...
public class TypeDatabaseHandler extends SQLiteOpenHelper {

    public static final String typeNameDb = "Type";
    public static final String idTypeDb = "id";
    public static final String nameTypeDb = "name";



    public static final String destroy_table_book = "DROP TABLE IF EXISTS " + typeNameDb + ";";


    public TypeDatabaseHandler(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    private String createTableBook(){
        ...
        return ("CREATE TABLE "+typeNameDb+" ( "+idTypeDb+" INTEGER PRIMARY KEY, "+nameTypeDb +" TEXT NOT NULL);");
    }
