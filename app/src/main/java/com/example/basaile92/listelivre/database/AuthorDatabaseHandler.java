...
public class AuthorDatabaseHandler extends SQLiteOpenHelper{


    public static final String authorNameDb = "Author";
    public static final String idAuthorDb = "id";
    public static final String nameAuthorDb = "name";
    public static final String isbnBookDb = "isbn";



    public static final String destroy_table_book = "DROP TABLE IF EXISTS " + authorNameDb + ";";


    public AuthorDatabaseHandler(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    private String createTableBook(){
        ...
        return ("CREATE TABLE "+authorNameDb+" ( "+idAuthorDb+" INTEGER PRIMARY KEY, "+isbnBookDb +" TEXT NOT NULL,"+ nameAuthorDb +" TEXT NOT NULL);");
    }
